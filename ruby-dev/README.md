...
# 一つのファイルにまとめる。
# jawiki.txtのサイズ: 約5.00GB(4,996,437,976) 処理時間: 約24秒
...
# 分かちを入れる。
# jawiki_wakati.txtのサイズ: 約5.65GB(5,647,652,287) 処理時間: 約52分
...
# word2vecに学習させる。
# 単語数: 約8億語(795,502,945)
# jawiki.binのサイズ: 約1.43GB(1,431,556,577) 処理時間: 約45分
